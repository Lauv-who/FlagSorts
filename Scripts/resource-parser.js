...
function get_emoji(emojip, sname) {
   var Lmoji = { 
    ...
    "🇩🇪": ["DE ", "DE-", "DE_", "German", "GERMAN", "Frankfurt", "德国", "德國", "法兰克福","京德","滬德","廣德","沪德","广德"],
    ...
    "🇨🇼": ["库拉索", "庫拉索", "Curaçao"],
    "🇬🇧": ["UK", "GB ", "England", "United Kingdom", "英国", "伦敦", "Britain"],
    ...
    "🇦🇪": ["United Arab Emirates", "阿联酋","AE ", "迪拜", "阿聯酋", "Dubai", "阿拉伯联合酋长国"],
    "🇧🇷": ["BR", "Brazil", "巴西", "圣保罗"],
    ...
    "🇦🇼": ["阿鲁巴", "Aruba"],
    "🇧🇿": ["伯利兹", "Belize"],
    "🇨🇬": ["刚果共和国", "Republic of the Congo", "刚果（布）"],
    "🇹🇲": ["土库曼斯坦", "Turkmenistan"],
    "🇹🇯": ["塔吉克斯坦", "Tajikistan"],
    "🇧🇸": ["巴哈马", "Bahamas"],
    "🇭🇹": ["海地", "Haiti"],
    "🇧🇴": ["玻利维亚", "Bolivia"],
    "🇵🇳": ["皮特凯恩群岛", "Pitcairn", "Pitcairn Islands"],
    "🇦🇬": ["安提瓜和巴布达", "Antigua and Barbuda"],
    "🇸🇸": ["南苏丹", "Sounth Sudan"],
    "🇸🇧": ["所罗门群岛", "Solomon", "Solomon Islands"],
    "🇸🇴": ["索马里", "Somalia"],
    "🇲🇱": ["马里", "Mali"],
    "🇰🇼": ["科威特", "Kuwait"],
    "🇻🇬": ["英属维尔京", "British Virgin Islands", "英属维尔京群岛"],
    "🇧🇯": ["贝宁", "Benin"],
    "🇨🇩": ["刚果民主共和国", "Democratic Republic of the Congo", "刚果（金）"],
    "🇨🇲": ["喀麦隆", "Cameroon"],
    "🇲🇿": ["莫桑比克", "Mozambique"],
    "🇨🇮": ["科特迪瓦", "Côte d’Ivoire"],
    "🇸🇿": ["斯威士兰", "Swaziland"],
